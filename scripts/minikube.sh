...
up)
    ...
    minikube start --memory="${MEMORY}" -b kubeadm --kubernetes-version="${KUBE_VERSION}" --vm-driver="${VM_DRIVER}" --feature-gates="${K8S_FEATURE_GATES}" --service-cluster-ip-range="192.168.123.0/24" --docker-opt "bip=192.168.123.0/24" ${EXTRA_CONFIG}
